...
final class Version20230205215532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE decision DROP decision_status, DROP status_color, DROP status_days_left');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE decision ADD decision_status VARCHAR(30) DEFAULT NULL, ADD status_color CHAR(7) DEFAULT NULL, ADD status_days_left VARCHAR(100) DEFAULT NULL');
    }
}
